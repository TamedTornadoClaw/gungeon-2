...
/** Geometry factories — structural, not tunable */
const MESH_GEOMETRIES: Record<MeshId, () => THREE.BufferGeometry> = {
  [MeshId.Player]: () => new THREE.BoxGeometry(1, 2, 1),
  [MeshId.KnifeRusher]: () => new THREE.BoxGeometry(0.8, 1.5, 0.8),
  [MeshId.ShieldGun]: () => new THREE.BoxGeometry(1, 2, 1),
  [MeshId.Shotgunner]: () => new THREE.BoxGeometry(1.2, 2, 1.2),
  [MeshId.Rifleman]: () => new THREE.BoxGeometry(1, 2, 1),
  [MeshId.SuicideBomber]: () => new THREE.SphereGeometry(0.6, 16, 16),
  [MeshId.MiniBossKnifeRusher]: () => new THREE.BoxGeometry(1.2, 2.2, 1.2),
  [MeshId.MiniBossShieldGun]: () => new THREE.BoxGeometry(1.4, 2.5, 1.4),
  [MeshId.MiniBossShotgunner]: () => new THREE.BoxGeometry(1.4, 2.5, 1.4),
  [MeshId.MiniBossRifleman]: () => new THREE.BoxGeometry(1.4, 2.5, 1.4),
  [MeshId.MiniBossSuicideBomber]: () => new THREE.BoxGeometry(1.2, 2, 1.2),
  [MeshId.Boss]: () => new THREE.BoxGeometry(2, 3, 2),
  [MeshId.Pistol]: () => new THREE.CylinderGeometry(0.05, 0.05, 0.5, 8),
  [MeshId.SMG]: () => new THREE.CylinderGeometry(0.05, 0.05, 0.6, 8),
  [MeshId.AssaultRifle]: () => new THREE.BoxGeometry(0.1, 0.1, 0.5),
  [MeshId.Shotgun]: () => new THREE.BoxGeometry(0.15, 0.1, 0.5),
  [MeshId.LMG]: () => new THREE.BoxGeometry(0.15, 0.15, 0.6),
  [MeshId.Bullet]: () => new THREE.SphereGeometry(0.05, 8, 8),
  [MeshId.EnemyBullet]: () => new THREE.SphereGeometry(0.05, 8, 8),
  [MeshId.XPGem]: () => new THREE.OctahedronGeometry(0.15),
  ...
  [MeshId.Floor]: () => { const g = new THREE.PlaneGeometry(1, 1); g.rotateX(-Math.PI / 2); return g; },
  [MeshId.Pit]: () => { const g = new THREE.PlaneGeometry(1, 1); g.rotateX(-Math.PI / 2); return g; },
  [MeshId.FireHazard]: () => { const g = new THREE.PlaneGeometry(1, 1); g.rotateX(-Math.PI / 2); return g; },
  [MeshId.SpikeHazard]: () => createSpikeHazardGeometry(),
  [MeshId.WaterHazard]: () => { const g = new THREE.PlaneGeometry(1, 1); g.rotateX(-Math.PI / 2); return g; },
